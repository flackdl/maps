...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryCrossingSection.latitude'
        db.add_column(u'entries_entrycrossingsection', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'EntryCrossingSection.longitude'
        db.add_column(u'entries_entrycrossingsection', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'EntryCuldesacSection.latitude'
        db.add_column(u'entries_entryculdesacsection', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'EntryCuldesacSection.longitude'
        db.add_column(u'entries_entryculdesacsection', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'EntrySegmentSection.latitude'
        db.add_column(u'entries_entrysegmentsection', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'EntrySegmentSection.longitude'
        db.add_column(u'entries_entrysegmentsection', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'EntryRouteSection.latitude'
        db.add_column(u'entries_entryroutesection', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'EntryRouteSection.longitude'
        db.add_column(u'entries_entryroutesection', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryCrossingSection.latitude'
        db.delete_column(u'entries_entrycrossingsection', 'latitude')

        # Deleting field 'EntryCrossingSection.longitude'
        db.delete_column(u'entries_entrycrossingsection', 'longitude')

        # Deleting field 'EntryCuldesacSection.latitude'
        db.delete_column(u'entries_entryculdesacsection', 'latitude')

        # Deleting field 'EntryCuldesacSection.longitude'
        db.delete_column(u'entries_entryculdesacsection', 'longitude')

        # Deleting field 'EntrySegmentSection.latitude'
        db.delete_column(u'entries_entrysegmentsection', 'latitude')

        # Deleting field 'EntrySegmentSection.longitude'
        db.delete_column(u'entries_entrysegmentsection', 'longitude')

        # Deleting field 'EntryRouteSection.latitude'
        db.delete_column(u'entries_entryroutesection', 'latitude')

        # Deleting field 'EntryRouteSection.longitude'
        db.delete_column(u'entries_entryroutesection', 'longitude')
    ...
    models = {
        ...
        u'entries.entry': {
            ...
            'ending_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'starting_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
