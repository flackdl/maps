...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryCrossingSection.position'
        db.add_column(u'entries_entrycrossingsection', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EntryCuldesacSection.position'
        db.add_column(u'entries_entryculdesacsection', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EntrySegmentSection.position'
        db.add_column(u'entries_entrysegmentsection', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EntryRouteSection.position'
        db.add_column(u'entries_entryroutesection', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryCrossingSection.position'
        db.delete_column(u'entries_entrycrossingsection', 'position')

        # Deleting field 'EntryCuldesacSection.position'
        db.delete_column(u'entries_entryculdesacsection', 'position')

        # Deleting field 'EntrySegmentSection.position'
        db.delete_column(u'entries_entrysegmentsection', 'position')

        # Deleting field 'EntryRouteSection.position'
        db.delete_column(u'entries_entryroutesection', 'position')
