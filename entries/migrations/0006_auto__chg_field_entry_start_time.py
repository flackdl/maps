...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.start_time'
        db.alter_column(u'entries_entry', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Entry.start_time'
        db.alter_column(u'entries_entry', 'start_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'entries.entry': {
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'}),
