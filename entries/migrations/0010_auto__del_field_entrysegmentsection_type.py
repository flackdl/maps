...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntrySegmentSection.type'
        db.delete_column(u'entries_entrysegmentsection', 'type')


    def backwards(self, orm):
        # Adding field 'EntrySegmentSection.type'
        db.add_column(u'entries_entrysegmentsection', 'type',
