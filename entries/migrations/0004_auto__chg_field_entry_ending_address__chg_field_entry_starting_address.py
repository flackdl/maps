...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.end_time'
        db.alter_column(u'entries_entry', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Entry.end_time'
        db.alter_column(u'entries_entry', 'end_time', self.gf('django.db.models.fields.DateTimeField')())
