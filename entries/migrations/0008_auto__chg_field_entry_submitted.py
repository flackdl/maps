...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.submitted'
        db.alter_column(u'entries_entry', 'submitted', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Entry.submitted'
        db.alter_column(u'entries_entry', 'submitted', self.gf('django.db.models.fields.DateTimeField')())
