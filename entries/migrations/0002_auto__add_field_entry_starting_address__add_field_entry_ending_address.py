...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.starting_address'
        db.add_column(u'entries_entry', 'starting_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Entry.ending_address'
        db.add_column(u'entries_entry', 'ending_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.starting_address'
        db.delete_column(u'entries_entry', 'starting_address')

        # Deleting field 'Entry.ending_address'
        db.delete_column(u'entries_entry', 'ending_address')
    ...
    models = {
        ...
        u'entries.entry': {
            ...
            'ending_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'route_number': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'starting_address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
