...
function CustomFileBrowser(field_name, url, type, win) {
    ...
    var admin_prefix = document.location.pathname.substring(0, document.location.pathname.indexOf('/admin'));
    var cmsURL = admin_prefix + '/admin/filebrowser/browse/?pop=2';
...
tinyMCE.init({
    ...
    // Only use on "Item Helpers"
    mode : "exact",
    elements : "id_itemhelper_set-0-content",
