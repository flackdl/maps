...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SurveyType.name'
        db.delete_column(u'maps_surveytype', 'name')

        # Adding field 'SurveyType.slug'
        db.add_column(u'maps_surveytype', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SurveyType.name'
        db.add_column(u'maps_surveytype', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True),
                      keep_default=False)

        # Deleting field 'SurveyType.slug'
        db.delete_column(u'maps_surveytype', 'slug')
    ...
    models = {
        ...
        u'maps.survey': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['maps.SurveyType']", 'null': 'True'}),
